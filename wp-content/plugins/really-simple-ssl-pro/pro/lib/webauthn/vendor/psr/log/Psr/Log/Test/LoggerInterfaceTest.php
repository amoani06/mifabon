...
namespace RSSProVendor\Psr\Log\Test;

use RSSProVendor\Psr\Log\LoggerInterface;
use RSSProVendor\Psr\Log\LogLevel;
use RSSProVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('RSSProVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('RSSProVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('RSSProVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
