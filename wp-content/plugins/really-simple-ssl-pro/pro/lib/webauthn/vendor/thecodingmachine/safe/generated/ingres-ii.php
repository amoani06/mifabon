...
use RSSProVendor\Safe\Exceptions\IngresiiException;
/**
...
{
    error_clear_last();
    $result = \RSSProVendor\ingres_autocommit($link);
    if ($result === \false) {
...
{
    error_clear_last();
    $result = \RSSProVendor\ingres_close($link);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \RSSProVendor\ingres_commit($link);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
function ingres_connect(?string $database = null, ?string $username = null, ?string $password = null, ?array $options = null)
{
    error_clear_last();
    if ($options !== null) {
        $result = \RSSProVendor\ingres_connect($database, $username, $password, $options);
    } elseif ($password !== null) {
        $result = \RSSProVendor\ingres_connect($database, $username, $password);
    } elseif ($username !== null) {
        $result = \RSSProVendor\ingres_connect($database, $username);
    } elseif ($database !== null) {
        $result = \RSSProVendor\ingres_connect($database);
    } else {
        $result = \RSSProVendor\ingres_connect();
    }
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
...
function ingres_execute($result, ?array $params = null, ?string $types = null): void
{
    error_clear_last();
    if ($types !== null) {
        $result = \RSSProVendor\ingres_execute($result, $params, $types);
    } elseif ($params !== null) {
        $result = \RSSProVendor\ingres_execute($result, $params);
    } else {
        $result = \RSSProVendor\ingres_execute($result);
    }
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \RSSProVendor\ingres_field_name($result, $index);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \RSSProVendor\ingres_field_type($result, $index);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \RSSProVendor\ingres_free_result($result);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
function ingres_pconnect(?string $database = null, ?string $username = null, ?string $password = null, ?array $options = null)
{
    error_clear_last();
    if ($options !== null) {
        $result = \RSSProVendor\ingres_pconnect($database, $username, $password, $options);
    } elseif ($password !== null) {
        $result = \RSSProVendor\ingres_pconnect($database, $username, $password);
    } elseif ($username !== null) {
        $result = \RSSProVendor\ingres_pconnect($database, $username);
    } elseif ($database !== null) {
        $result = \RSSProVendor\ingres_pconnect($database);
    } else {
        $result = \RSSProVendor\ingres_pconnect();
    }
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \RSSProVendor\ingres_result_seek($result, $position);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \RSSProVendor\ingres_rollback($link);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \RSSProVendor\ingres_set_environment($link, $options);
    if ($result === \false) {
        throw IngresiiException::createFromPhpError();
    }
}
