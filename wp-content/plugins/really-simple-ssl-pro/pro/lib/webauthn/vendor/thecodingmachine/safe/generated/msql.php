...
namespace RSSProVendor\Safe;

use RSSProVendor\Safe\Exceptions\MsqlException;
/**
...
{
    error_clear_last();
    $result = \RSSProVendor\msql_affected_rows($result);
    if ($result === \false) {
...
function msql_close($link_identifier = null): void
{
    ...
    if ($link_identifier !== null) {
        $result = \RSSProVendor\msql_close($link_identifier);
    } else {
        $result = \RSSProVendor\msql_close();
    }
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
...
function msql_connect(?string $hostname = null)
{
    error_clear_last();
    if ($hostname !== null) {
        $result = \RSSProVendor\msql_connect($hostname);
    } else {
        $result = \RSSProVendor\msql_connect();
    }
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
...
function msql_create_db(string $database_name, $link_identifier = null): void
{
    error_clear_last();
    if ($link_identifier !== null) {
        $result = \RSSProVendor\msql_create_db($database_name, $link_identifier);
    } else {
        $result = \RSSProVendor\msql_create_db($database_name);
    }
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \RSSProVendor\msql_data_seek($result, $row_number);
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
}
...
function msql_db_query(string $database, string $query, $link_identifier = null)
{
    error_clear_last();
    if ($link_identifier !== null) {
        $result = \RSSProVendor\msql_db_query($database, $query, $link_identifier);
    } else {
        $result = \RSSProVendor\msql_db_query($database, $query);
    }
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
...
function msql_drop_db(string $database_name, $link_identifier = null): void
{
    error_clear_last();
    if ($link_identifier !== null) {
        $result = \RSSProVendor\msql_drop_db($database_name, $link_identifier);
    } else {
        $result = \RSSProVendor\msql_drop_db($database_name);
    }
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
...
{
    error_clear_last();
    $result = \RSSProVendor\msql_field_len($result, $field_offset);
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \RSSProVendor\msql_field_name($result, $field_offset);
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \RSSProVendor\msql_field_seek($result, $field_offset);
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
}
...
{
    error_clear_last();
    $result = \RSSProVendor\msql_field_table($result, $field_offset);
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \RSSProVendor\msql_field_type($result, $field_offset);
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \RSSProVendor\msql_free_result($result);
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
}
...
function msql_pconnect(?string $hostname = null)
{
    error_clear_last();
    if ($hostname !== null) {
        $result = \RSSProVendor\msql_pconnect($hostname);
    } else {
        $result = \RSSProVendor\msql_pconnect();
    }
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
...
function msql_query(string $query, $link_identifier = null)
{
    error_clear_last();
    if ($link_identifier !== null) {
        $result = \RSSProVendor\msql_query($query, $link_identifier);
    } else {
        $result = \RSSProVendor\msql_query($query);
    }
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
...
function msql_select_db(string $database_name, $link_identifier = null): void
{
    error_clear_last();
    if ($link_identifier !== null) {
        $result = \RSSProVendor\msql_select_db($database_name, $link_identifier);
    } else {
        $result = \RSSProVendor\msql_select_db($database_name);
    }
    if ($result === \false) {
        throw MsqlException::createFromPhpError();
    }
