...
use RSSProVendor\Safe\Exceptions\MysqlndMsException;
/**
...
{
    error_clear_last();
    $result = \RSSProVendor\mysqlnd_ms_dump_servers($connection);
    if ($result === \false) {
...
{
    error_clear_last();
    $result = \RSSProVendor\mysqlnd_ms_fabric_select_global($connection, $table_name);
    if ($result === \false) {
        throw MysqlndMsException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \RSSProVendor\mysqlnd_ms_fabric_select_shard($connection, $table_name, $shard_key);
    if ($result === \false) {
        throw MysqlndMsException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \RSSProVendor\mysqlnd_ms_get_last_used_connection($connection);
    if ($result === \false) {
        throw MysqlndMsException::createFromPhpError();
    }
    return $result;
