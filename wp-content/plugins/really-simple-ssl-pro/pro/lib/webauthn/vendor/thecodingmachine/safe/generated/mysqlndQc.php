...
use RSSProVendor\Safe\Exceptions\MysqlndQcException;
/**
...
{
    error_clear_last();
    $result = \RSSProVendor\mysqlnd_qc_clear_cache();
    if ($result === \false) {
...
{
    error_clear_last();
    $result = \RSSProVendor\mysqlnd_qc_set_is_select($callback);
    if ($result === \false) {
        throw MysqlndQcException::createFromPhpError();
    }
    return $result;
...
{
    error_clear_last();
    $result = \RSSProVendor\mysqlnd_qc_set_storage_handler($handler);
    if ($result === \false) {
        throw MysqlndQcException::createFromPhpError();
    }
}
