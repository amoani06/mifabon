 ...
 */
namespace RSSProVendor\CBOR\Tag;

use RSSProVendor\CBOR\ByteStringObject;
use RSSProVendor\CBOR\CBORObject;
use RSSProVendor\CBOR\IndefiniteLengthByteStringObject;
use RSSProVendor\CBOR\IndefiniteLengthTextStringObject;
use RSSProVendor\CBOR\Tag;
use RSSProVendor\CBOR\TextStringObject;
...
final class Base64EncodingTag extends Tag
{
    ...
    public function getNormalizedData(bool $ignoreTags = \false)
    {
        ...
        $result = base64_decode($this->object->getNormalizedData($ignoreTags), \true);
        if ($result === \false) {
