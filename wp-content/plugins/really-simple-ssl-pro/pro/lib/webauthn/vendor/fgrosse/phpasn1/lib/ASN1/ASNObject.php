 ...
 */
namespace RSSProVendor\FG\ASN1;

use RSSProVendor\FG\ASN1\Exception\ParserException;
use RSSProVendor\FG\ASN1\Universal\BitString;
use RSSProVendor\FG\ASN1\Universal\Boolean;
use RSSProVendor\FG\ASN1\Universal\Enumerated;
use RSSProVendor\FG\ASN1\Universal\GeneralizedTime;
use RSSProVendor\FG\ASN1\Universal\Integer;
use RSSProVendor\FG\ASN1\Universal\NullObject;
use RSSProVendor\FG\ASN1\Universal\ObjectIdentifier;
use RSSProVendor\FG\ASN1\Universal\RelativeObjectIdentifier;
use RSSProVendor\FG\ASN1\Universal\OctetString;
use RSSProVendor\FG\ASN1\Universal\Sequence;
use RSSProVendor\FG\ASN1\Universal\Set;
use RSSProVendor\FG\ASN1\Universal\UTCTime;
use RSSProVendor\FG\ASN1\Universal\IA5String;
use RSSProVendor\FG\ASN1\Universal\PrintableString;
use RSSProVendor\FG\ASN1\Universal\NumericString;
use RSSProVendor\FG\ASN1\Universal\UTF8String;
use RSSProVendor\FG\ASN1\Universal\UniversalString;
use RSSProVendor\FG\ASN1\Universal\CharacterString;
use RSSProVendor\FG\ASN1\Universal\GeneralString;
use RSSProVendor\FG\ASN1\Universal\VisibleString;
use RSSProVendor\FG\ASN1\Universal\GraphicString;
use RSSProVendor\FG\ASN1\Universal\BMPString;
use RSSProVendor\FG\ASN1\Universal\T61String;
use RSSProVendor\FG\ASN1\Universal\ObjectDescriptor;
use RSSProVendor\FG\Utility\BigInteger;
use LogicException;
/**
...
abstract class ASNObject implements Parsable
{
    ...
    protected static function parseContentLength(&$binaryData, &$offsetIndex, $minimumLength = 0)
    {
        ...
        if (($contentLength & 0x80) != 0) {
            ...
            $contentLength = BigInteger::create(0x0);
