...
class Identifier
{
    const CLASS_UNIVERSAL = 0x0;
    const CLASS_APPLICATION = 0x1;
    const CLASS_CONTEXT_SPECIFIC = 0x2;
    const CLASS_PRIVATE = 0x3;
    const EOC = 0x0;
    // unsupported for now
    const BOOLEAN = 0x1;
    const INTEGER = 0x2;
    const BITSTRING = 0x3;
    const OCTETSTRING = 0x4;
    const NULL = 0x5;
    const OBJECT_IDENTIFIER = 0x6;
    const OBJECT_DESCRIPTOR = 0x7;
    const EXTERNAL = 0x8;
    // unsupported for now
    const REAL = 0x9;
    // unsupported for now
    const ENUMERATED = 0xa;
    const EMBEDDED_PDV = 0xb;
    // unsupported for now
    const UTF8_STRING = 0xc;
    const RELATIVE_OID = 0xd;
    ...
    // sometimes referred to as TeletextString
