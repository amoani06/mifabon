 ...
 */
namespace RSSProVendor\FG\X509\CSR;

use RSSProVendor\FG\ASN1\OID;
...
use RSSProVendor\FG\X509\CertificateSubject;
use RSSProVendor\FG\X509\AlgorithmIdentifier;
use RSSProVendor\FG\X509\PublicKey;
class CSR extends Sequence
{
    ...
    {
        $this->subject = new CertificateSubject($commonName, $email, $organization, $locality, $state, $country, $organizationalUnit);
