...
namespace RSSProVendor\Brick\Math;

use RSSProVendor\Brick\Math\Exception\DivisionByZeroException;
use RSSProVendor\Brick\Math\Exception\IntegerOverflowException;
use RSSProVendor\Brick\Math\Exception\MathException;
use RSSProVendor\Brick\Math\Exception\NegativeNumberException;
use RSSProVendor\Brick\Math\Exception\NumberFormatException;
use RSSProVendor\Brick\Math\Internal\Calculator;
/**
