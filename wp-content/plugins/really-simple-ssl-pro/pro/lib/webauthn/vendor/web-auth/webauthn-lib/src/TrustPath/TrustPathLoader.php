 ...
 */
namespace RSSProVendor\Webauthn\TrustPath;

use function array_key_exists;
use RSSProVendor\Assert\Assertion;
use function in_array;
use InvalidArgumentException;
use function RSSProVendor\Safe\class_implements;
...
abstract class TrustPathLoader
{
    ...
    public static function loadTrustPath(array $data): TrustPath
    {
        ...
        switch (\true) {
            ...
            case class_exists($type):
                ...
                if (in_array(TrustPath::class, $implements, \true)) {
    ...
    {
        return ['empty' => EmptyTrustPath::class, 'ecdaa_key_id' => EcdaaKeyIdTrustPath::class, 'x5c' => CertificateTrustPath::class];
    }
}
