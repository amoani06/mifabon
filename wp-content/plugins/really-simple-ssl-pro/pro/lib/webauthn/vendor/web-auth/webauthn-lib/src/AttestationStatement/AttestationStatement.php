...
class AttestationStatement implements JsonSerializable
{
    ...
    public static function createFromArray(array $data): self
    {
        ...
        return new self($data['fmt'], $data['attStmt'], $data['type'], TrustPathLoader::loadTrustPath($data['trustPath']));
    }
    /**
     * @return mixed[]
     */
    ...
    {
        return ['fmt' => $this->fmt, 'attStmt' => $this->attStmt, 'trustPath' => $this->trustPath->jsonSerialize(), 'type' => $this->type];
    }
}
