...
use RSSProVendor\CBOR\Stream;
use function RSSProVendor\Safe\fclose;
use function RSSProVendor\Safe\fopen;
use function RSSProVendor\Safe\fread;
use function RSSProVendor\Safe\fwrite;
use function RSSProVendor\Safe\rewind;
