...
use RSSProVendor\Jose\Component\Core\Algorithm as AlgorithmInterface;
use RSSProVendor\Jose\Component\Core\AlgorithmManager;
use RSSProVendor\Jose\Component\Core\Util\JsonConverter;
use RSSProVendor\Jose\Component\KeyManagement\JWKFactory;
use RSSProVendor\Jose\Component\Signature\Algorithm;
use RSSProVendor\Jose\Component\Signature\JWS;
use RSSProVendor\Jose\Component\Signature\JWSVerifier;
use RSSProVendor\Jose\Component\Signature\Serializer\CompactSerializer;
use RSSProVendor\Psr\Http\Client\ClientInterface;
use RSSProVendor\Psr\Http\Message\RequestFactoryInterface;
use RSSProVendor\Psr\Http\Message\ResponseInterface;
...
final class AndroidSafetyNetAttestationStatementSupport implements AttestationStatementSupport
{
    ...
    public function load(array $attestation): AttestationStatement
    {
        ...
        return AttestationStatement::createBasic($this->name(), $attestation['attStmt'], new CertificateTrustPath($certificates));
    }
    ...
    private function validatePayload(?string $payload, string $clientDataJSONHash, AuthenticatorData $authenticatorData): void
    {
        ...
        Assertion::eq($payload['nonce'], base64_encode(hash('sha256', $authenticatorData->getAuthData() . $clientDataJSONHash, \true)), 'Invalid attestation object. Invalid nonce');
    ...
    private function validateUsingGoogleApi(AttestationStatement $attestationStatement): void
    {
        ...
        $responseBodyJson = json_decode($responseBody, \true);
    ...
    {
        $algorithmClasses = [Algorithm\RS256::class, Algorithm\RS384::class, Algorithm\RS512::class, Algorithm\PS256::class, Algorithm\PS384::class, Algorithm\PS512::class, Algorithm\ES256::class, Algorithm\ES384::class, Algorithm\ES512::class, Algorithm\EdDSA::class];
