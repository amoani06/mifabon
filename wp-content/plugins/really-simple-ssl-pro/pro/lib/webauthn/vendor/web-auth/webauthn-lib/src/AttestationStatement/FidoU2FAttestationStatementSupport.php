...
final class FidoU2FAttestationStatementSupport implements AttestationStatementSupport
{
    ...
    {
        Assertion::eq($authenticatorData->getAttestedCredentialData()->getAaguid()->toString(), '00000000-0000-0000-0000-000000000000', 'Invalid AAGUID for fido-u2f attestation statement. Shall be "00000000-0000-0000-0000-000000000000"');
