...
use function count;
use RSSProVendor\FG\ASN1\ASNObject;
use RSSProVendor\FG\ASN1\ExplicitlyTaggedObject;
use RSSProVendor\FG\ASN1\Universal\OctetString;
use RSSProVendor\FG\ASN1\Universal\Sequence;
use function RSSProVendor\Safe\hex2bin;
use function RSSProVendor\Safe\openssl_pkey_get_public;
