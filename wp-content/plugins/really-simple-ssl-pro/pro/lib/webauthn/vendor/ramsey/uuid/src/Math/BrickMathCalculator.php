...
namespace RSSProVendor\Ramsey\Uuid\Math;

use RSSProVendor\Brick\Math\BigDecimal;
use RSSProVendor\Brick\Math\BigInteger;
use RSSProVendor\Brick\Math\Exception\MathException;
use RSSProVendor\Brick\Math\RoundingMode as BrickMathRounding;
use RSSProVendor\Ramsey\Uuid\Exception\InvalidArgumentException;
use RSSProVendor\Ramsey\Uuid\Type\Decimal;
use RSSProVendor\Ramsey\Uuid\Type\Hexadecimal;
use RSSProVendor\Ramsey\Uuid\Type\Integer as IntegerObject;
use RSSProVendor\Ramsey\Uuid\Type\NumberInterface;
/**
