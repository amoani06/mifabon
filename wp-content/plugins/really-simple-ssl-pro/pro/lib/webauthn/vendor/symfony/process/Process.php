 ...
 */
namespace RSSProVendor\Symfony\Component\Process;

use RSSProVendor\Symfony\Component\Process\Exception\InvalidArgumentException;
use RSSProVendor\Symfony\Component\Process\Exception\LogicException;
use RSSProVendor\Symfony\Component\Process\Exception\ProcessFailedException;
use RSSProVendor\Symfony\Component\Process\Exception\ProcessSignaledException;
use RSSProVendor\Symfony\Component\Process\Exception\ProcessTimedOutException;
use RSSProVendor\Symfony\Component\Process\Exception\RuntimeException;
use RSSProVendor\Symfony\Component\Process\Pipes\PipesInterface;
use RSSProVendor\Symfony\Component\Process\Pipes\UnixPipes;
use RSSProVendor\Symfony\Component\Process\Pipes\WindowsPipes;
/**
...
class Process implements \IteratorAggregate
{
    ...
    {
        if (!\function_exists('proc_open') && !\function_exists('RSSProVendor\proc_open')) {
    ...
    protected function isSigchildEnabled()
    {
        ...
        if (!\function_exists('phpinfo') && !\function_exists('RSSProVendor\phpinfo')) {
