...
function foxyshop_cfbe_metabox($post_type) {
	...
	<table class="widefat cfbe_table cfbe_foxyshop_table">
		<thead>
			<tr>
				<th><img src="<?php echo esc_url(FOXYSHOP_DIR . '/images/icon.png'); ?>" alt="" /><?php echo wp_kses_post(sprintf(__('Set Values For Checked FoxyShop %s'), FOXYSHOP_PRODUCT_NAME_PLURAL)); ?></th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				<td>
					...
					<label for="_category_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_category_status" id="_category_status1" value="1" />
					<label for="_category_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_saleprice_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_salestartdate_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_salestartdate_status" id="_salestartdate_status1" value="1" />
					<label for="_salestartdate_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_saleenddate_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_saleenddate_status" id="_saleenddate_status1" value="1" />
					<label for="_saleenddate_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_price_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_price_status" id="_price_status1" value="1" />
					<label for="_price_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_weight_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_weight_status" id="_weight_status1" value="1" />
					<label for="_weight_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_quantity_min_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_quantity_min_status" id="_quantity_min_status1" value="1" />
					<label for="_quantity_min_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_quantity_max_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_quantity_max_status" id="_quantity_max_status1" value="1" />
					<label for="_quantity_max_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_quantity_hide_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
			...
			<tr>
				<td>
					...
					<label for="_hide_product_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
			...
			<tr>
				<td>
					...
					<label for="_discount_quantity_amount_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_discount_quantity_amount_status" id="_discount_quantity_amount_status1" value="1" />
					<label for="_discount_quantity_amount_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_discount_quantity_percentage_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_discount_quantity_percentage_status" id="_discount_quantity_percentage_status1" value="1" />
					<label for="_discount_quantity_percentage_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_discount_price_amount_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_discount_price_amount_status" id="_discount_price_amount_status1" value="1" />
					<label for="_discount_price_amount_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_discount_price_percentage_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_discount_price_percentage_status" id="_discount_price_percentage_status1" value="1" />
					<label for="_discount_price_percentage_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_sub_frequency_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_sub_frequency_status" id="_sub_frequency_status1" value="1" />
					<label for="_sub_frequency_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_sub_startdate_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_sub_startdate_status" id="_sub_startdate_status1" value="1" />
					<label for="_sub_startdate_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_sub_enddate_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_sub_enddate_status" id="_sub_enddate_status1" value="1" />
					<label for="_sub_enddate_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			if ($foxyshop_settings['google_product_support']) :
				foreach ($google_product_field_names as $field) {
					...
					<tr>
						<td>
							<label for="_<?php echo esc_attr($field); ?>" class="cfbe_special_label"><?php echo esc_html($display_title); ?></label>
							<input type="radio" name="_<?php echo esc_attr($field); ?>_status" id="_<?php echo esc_attr($field); ?>_status0" value="0" checked="checked" />
							<label for="_<?php echo esc_attr($field); ?>_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
							<input type="radio" name="_<?php echo esc_attr($field); ?>_status" id="_<?php echo esc_attr($field); ?>_status1" value="1" />
							<label for="_<?php echo esc_attr($field); ?>_status1"><?php echo esc_html($change_to_text); ?>:</label>
							<input type="text" name="_<?php echo esc_attr($field); ?>" id="_<?php echo esc_attr($field); ?>" value="" class="cfbe_field_name" onfocus="jQuery('#_<?php echo esc_attr($field); ?>_status1').prop('checked', true);" style="width: 300px;" />
			...
			<tr>
				<td>
					...
					<label for="_related_products_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_related_products_status" id="_related_products_status1" value="1" />
					<label for="_related_products_status1"><?php echo esc_html($change_to_text); ?>:</label>
					<select name="_related_products_list[]" id="_related_products_list" data-placeholder="Search for <?php echo esc_attr(FOXYSHOP_PRODUCT_NAME_PLURAL); ?>" style="width: 100%;" class="chzn-select" multiple="multiple">
						<?php echo foxy_wp_kses_html($all_product_list, ['option']); ?>
					</select>
					<div style="clear: both;"></div>
				</td>
			</tr>
			...
			<tr>
				<td>
					...
					<label for="_bundled_products_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_bundled_products_status" id="_bundled_products_status1" value="1" />
					<label for="_bundled_products_status1"><?php echo esc_html($change_to_text); ?>:</label>
			...
			<tr>
				<td>
					...
					<label for="_addon_products_status0" class="cfbe_leave_unchanged"><?php echo esc_html($leave_unchanged_text); ?></label>
					<input type="radio" name="_addon_products_status" id="_addon_products_status1" value="1" />
					<label for="_addon_products_status1"><?php echo esc_html($change_to_text); ?>:</label>
...
function foxyshop_cfbe_save($post_type, $post_id) {
	...
	foreach ($fields as $field) {
		if ($_POST['_' . $field . '_status'] == 1) cfbe_save_meta_data('_'.$field, sanitize_text_field($_POST['_'.$field]));
	}
	...
	foreach ($fields as $field) {
		if ($_POST['_' . $field . '_status'] == 1 && $_POST['_' . $field] != "") {
			...
			$new_price = (string)sanitize_text_field($_POST['_' . $field]);
	...
	if ($_POST['_quantity_min_status'] == 1) {
		cfbe_save_meta_data('_quantity_min', (int)sanitize_text_field($_POST['_quantity_min']));
	}
	if ($_POST['_quantity_max_status'] == 1) {
		cfbe_save_meta_data('_quantity_max', (int)sanitize_text_field($_POST['_quantity_max']));
	}
	if ($_POST['_salestartdate_status'] == 1) {
		...
		else cfbe_save_meta_data('_salestartdate', sanitize_text_field($_salestartdate));
	}
	if ($_POST['_saleenddate_status'] == 1) {
		...
		else cfbe_save_meta_data('_saleenddate', sanitize_text_field($_saleenddate));
	}
	...
	if ($foxyshop_settings['google_product_support']) {
		foreach($google_product_field_names as $field) {
			if ($_POST['_' . $field . '_status'] == 1) {
				cfbe_save_meta_data('_'.$field, sanitize_text_field($_POST['_'.$field]));
			}
		}
	}
